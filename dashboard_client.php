        ...
        <div class="grid">
            ...
            <?php foreach ($tasks as $task): ?>
                <article class="card">
                    ...
                    <?php if (!empty($task['runner_id'])): ?><p><a class="cta-button" href="task_chat.php?task_id=<?php echo (int) $task['id']; ?>">Open Chat</a> <a class="cta-button" href="task_tracking.php?task_id=<?php echo (int) $task['id']; ?>">Track Runner</a></p><?php endif; ?>
