...
CREATE TABLE runner_location_logs (
    ...
    INDEX idx_runner_location_logs_runner_time (runner_id, captured_at),
    INDEX idx_runner_location_logs_task_time (task_id, captured_at)
) ENGINE=InnoDB;
...
CREATE TABLE device_sessions (
    ...
    INDEX idx_device_sessions_user_platform (user_id, platform)
) ENGINE=InnoDB;
