...
import RunnerProfilePage from "./pages/shared/RunnerProfilePage";
      ...
      <BrowserRouter>
        <AuthProvider>
          <Routes>
            ...
            <Route path="/customer/messages" element={<ProtectedRoute><MessagingPage type="customer" /></ProtectedRoute>} />
            ...
            <Route path="/runner/messages" element={<ProtectedRoute requireVerified><MessagingPage type="runner" /></ProtectedRoute>} />
            
            {/* Shared runner profile view */}
            <Route path="/runner-profile/:id" element={<ProtectedRoute><RunnerProfilePage /></ProtectedRoute>} />
